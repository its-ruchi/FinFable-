        ...
        <CardContent>
          <form className="space-y-4">
            ...
            <div>
              ...
              <Input id="email" type="email" placeholder="Your email" className="border-blue-300 focus:border-blue-500" />
            </div>
            <div>
              <label htmlFor="message" className="block mb-2 text-blue-700">Message</label>
              <Textarea id="message" placeholder="Your message" rows={5} className="border-blue-300 focus:border-blue-500" />
            </div>
